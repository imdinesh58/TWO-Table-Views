...
SWIFT_CLASS("_TtC17CoreDataSampleApp19MediaViewController")
...
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tblView2;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified searchBar2;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull table1Data;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull table2Data;
- (void)viewDidLoad;
- (IBAction)Addd;
...
SWIFT_CLASS("_TtC17CoreDataSampleApp18pageViewController")
